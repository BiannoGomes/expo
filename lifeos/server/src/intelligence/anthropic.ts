    ...
    const result = await jsonCall(
      {
        ...
        max_tokens: 1500,
        system:
          "You generate the Life OS morning plan: at most five slots " +
    ...
    const { reply, ...extraction } = await jsonCall(
      {
        ...
        max_tokens: 2500,
        system:
          "You process the Life OS evening debrief. Extract structured data from the " +
    ...
    return jsonCall(
      {
        ...
        max_tokens: 800,
        system:
          "You are guiding one chapter of the Life OS onboarding — a conversation, never a form. " +
    ...
    return jsonCall(
      {
        ...
        max_tokens: 2000,
        system:
          "Extract candidate assertions from this completed Life OS onboarding chapter transcript. " +
    ...
    return jsonCall(
      {
        ...
        max_tokens: 4000,
        system:
          "You are the Life OS onboarding synthesis. From the candidate assertions, produce:\n" +
    ...
    return jsonCall(
      {
        ...
        max_tokens: 2500,
        system:
          "You are the Life OS weekly deep review. Re-test the current bottleneck hypothesis " +
