# Life OS — Gap Analysis of the Current Model
...
| Name decision | Part 1 leans Life OS; Part 2 uses Life OS throughout. | Settled — record it: the product is **Life OS**. |
...
4. **Notifications and presence are unaddressed.** §60 forbids
   ...
   re-engagement surface. The spec never says how Life OS shows up in a
