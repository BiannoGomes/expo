# Dawnward — Gap Analysis of the Current Model
...
| Name decision | Part 1 leans Dawnward; Part 2 uses Dawnward throughout. | Settled — record it: the product is **Dawnward**. |
...
4. **Notifications and presence are unaddressed.** §60 forbids
   ...
   re-engagement surface. The spec never says how Dawnward shows up in a
